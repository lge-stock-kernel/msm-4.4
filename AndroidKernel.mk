...
ifeq ($(PRODUCT_SUPPORT_EXFAT), y)
	...
	@sh tuxera_update.sh --target target/lg.d/mobile-msm8998 --use-cache --latest --max-cache-entries 2 --source-dir $(ANDROID_BUILD_TOP)/kernel/msm-4.4 --output-dir $(ANDROID_BUILD_TOP)/$(KERNEL_OUT) $(SUPPORT_EXFAT_TUXERA)
