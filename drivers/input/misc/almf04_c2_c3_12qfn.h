...
#define ADDR_EFLA_CTRL              0xFC	//eflash control register
	...
	#define ADDR_ROM_SAFE				0xFB	//eflash write º¸È£ ·çÆ¾
...
#define IDX_ICODE_ITSSTVT				6
	...
	#define MAX_CNT_INITCODE				CNT_INITCODE-1
#if defined (CONFIG_MACH_MSM8996_TF10)
        ...
        static const unsigned char InitCodeVal[CNT_INITCODE]  = { 0x00, 0x12, 0x00, 0xAD, 0x00, 0x52, 0x00, 0xF6, 0x07, 0x33, 0x3F, 0x23, 0x14, 0x66, 0x64, 0x66, 0x64, 0xBC, 0x89, 0x40, 0x0C, 0x04, 0x11, 0x07, 0x33, 0xFF, 0xFF, 0x82, 0x86, 0x83, 0x87 };
#else
	static const unsigned char InitCodeAddr[CNT_INITCODE] = { 0x01, 0x02, 0x03, 0x04, 0x07, 0x08, 0x09, 0x0A, 0X0D, 0x0E, 0x0F, 0x10, 0x11, 0x14, 0x15, 0x16, 0x17, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x24, 0x25, 0x26, 0x28, 0x29, 0x2A, 0x2B };
...
#endif	//CONFIG_MACH_MSM8996_TF10
#endif
