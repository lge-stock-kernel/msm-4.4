...
#ifdef CONFIG_LGE_USB
/* Ellisys: TD.PD.SRC.E6 PSHardResetTimer Timeout */
DECL_TCPC_TIMEOUT(PD_TIMER_PS_HARD_RESET, (25 - 2)),
#else
...
/* TYPEC-DEBOUNCE-TIMER */
/* Lecroy: 4.7.3 Try.SNK DRP Connect Try.SRC DRP Test */
DECL_TCPC_TIMEOUT_RANGE(TYPEC_TIMER_CCDEBOUNCE, 100, (200-50)),
